...
export const SliderData = [
...

    {
        ...
        price: 'Our program is inclusive; it is robust, uniform, and a cost-effective mechanism satisfying all of the requirements for Program Evaluation all regulators across North America, with an emphasis on the National Energy Board’s requirements.',
        path: '/homes',
        label: 'View Home',
        image: ImageThree,
        alt: 'House'
